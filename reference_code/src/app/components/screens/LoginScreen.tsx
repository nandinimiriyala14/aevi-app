...
export function LoginScreen() {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(180deg, #e2c8c5 0%, #ebd4d1 25%, #f0dbd9 55%)' }}
    >
      {/* Top section */}
      ...
      <div className="flex justify-center mt-2 mb-0">
        <AeviLogo size="md" showText={true} />
      </div>

      {/* Form card */}
      <div
        className="mx-4 rounded-3xl px-5 py-6 flex flex-col gap-4 flex-1"
        style={{
      ...
      >
        ...
        <div className="flex gap-3 mt-2">
          <button
            className="flex-1 flex items-center justify-center gap-2 py-3 rounded-2xl transition-opacity active:opacity-80"
            style={{
              background: 'white',
              border: '1.5px solid rgba(180,130,130,0.25)',
              cursor: 'pointer',
              fontFamily: 'Inter, sans-serif',
              fontSize: '14px',
              color: '#2d1818',
