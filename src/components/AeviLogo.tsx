...
export default function AeviLogo({ size = 70, showText = true }: AeviLogoProps) {
  const textFontSize = Math.round(size * 0.62);
  ...
  return (
    <View style={styles.wrapper}>
      ...
      {showText && (
        <Text style={[styles.text, { fontSize: textFontSize }]}>Aevi</Text>
      )}
    </View>
  );
}
